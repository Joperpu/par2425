...
![Hilos cable](assets/images/ud2/img19.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img20.png){ widht="400px" }

Cuando ya esté cortado tira del aislamiento hasta dejar ver los 8 hilos cruzados en 4 pares.

![Creación del cable](assets/images/ud2/img21.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img22.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img23.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img24.png){ widht="400px" }
![Creación del cable](assets/images/ud2/img25.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img26.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img27.png){ widht="400px" }
...
![Creación del cable](assets/images/ud2/img28.png){ widht="400px" }
